...
* [Código de Conduta](https://github.com/soujava/codigo-de-conduta-Discord-javadevbr/blob/master/README.md#código-de-conduta)
* [Como participar do grupo?](https://github.com/soujava/codigo-de-conduta-Discord-javadevbr/blob/master/README.md#como-participar-do-grupo)
* [Regras de etiqueta - Discord](https://github.com/soujava/codigo-de-conduta-Discord-javadevbr/blob/master/README.md#regras-de-etiqueta---Discord)
  * [Comandos](https://github.com/soujava/codigo-de-conduta-Discord-javadevbr/codigo-de-conduta/blob/master/README.md#comandos)
  * [Dúvidas](https://github.com/soujava/codigo-de-conduta-Discord-javadevbr/blob/master/README.md#dúvidas)
  * [Seja gentil](https://github.com/soujava/codigo-de-conduta-Discord-javadevbr/blob/master/README.md#seja-gentil)
  * [Responsabilidade individual](https://github.com/soujava/codigo-de-conduta-Discord-javadevbr/blob/master/README.md#responsabilidade-individual)
  * [Arquivos e links](https://github.com/soujava/codigo-de-conduta-Discord-javadevbr/blob/master/README.md#arquivos-e-links)
  * [Canais](https://github.com/soujava/codigo-de-conduta-Discord-javadevbr/blob/master/README.md#canais)
  * [Bots e integrações](https://github.com/davidtcdeveloper/codigo-de-conduta/blob/master/README.md#bots-e-integrações)
  * [Conhecendo o Discord](https://github.com/soujava/codigo-de-conduta-Discord-javadevbr/blob/master/README.md#conhecendo-o-Discord)
  * [Sugestões e melhorias](https://github.com/soujava/codigo-de-conduta-Discord-javadevbr/blob/master/README.md#sugestões-e-melhorias)

## Código de Conduta

Nossa comunidade tem como objetivo reunir os interessados na plataforma Java e incentivar o debate a respeito de inovações e melhorias nela além de possibilitar a troca de experiências e conhecimentos entre seus membros. Contudo, o Discord JavaBahia não se responsabiliza pelas ações de seus membros e espera que todos tenham uma atitude ética e responsável resguardandos-se do direito de remover conteúdo inapropriado e membros em desacordo com ações éticas. 
...
* **Antonio Lázaro** - @Popete#6346
* **Ivan Queiroz** - @Diachos#9630
...
O Discord permite que qualquer membro crie novos canais. O JavaBahia possui vários canais para discussões gerais ou específicas. O objetivo de ter diversos canais é permitir que membros com interesse em determinado assunto possam conversar de maneira mais focada, além de permitir que diversas conversas ocorram em paralelo. Antes de criar um canal, porém, verifique se há interesse de outros membros em participar do canal, se não existe um canal equivalente e se o foco do canal está de acordo com o propósito maior do JavaBahia e com o presente Código de Conduta. A equipe de Admins se reserva o direito de fechar e arquivar canais em duplicidade ou inativos por longos períodos.
...
A equipe de Admins se reserva o direito de controlar a configuração de bots e integrações, não sendo permitido aos demais membros ativar novas configurações de bots ou integrações. Desta forma, protegemos o grupo da criação de integrações maliciosas ou com propósitos que divergem do JavaBahia.

Principais estão integrados ao nosso Discord:
* [Discord Archive Bot](http://Discordarchive.io/): Copia todas as mensagens trocadas pelos canais públicos para um arquivo permanente, acessível através do link http://javadevbr.Discordarchive.io/.
* [Paperbot](http://paperbot.ai/): Monitora os links enviados para a geração de um portal web e e-mails de resumo diário. Desta forma, todos os links enviados por nossos membros nos canais públicos podem ser conferidos em [um portal centralizado](web.paperbot.ai). Basta logar com seu usuário do Discord para ter acesso à lista de links.

### Conhecendo o Discord
É novo no Discord? Não tem problema, o JavaBahia é aberto à participação de todos. Quer tirar o máximo proveito da ferramenta? Tire um tempo para ler um pouco da [ajuda disponível](https://get.Discord.help/hc/en-us/categories/200111606-Using-Discord), consulte os [atalhos disponíveis](https://get.Discord.help/hc/en-us/articles/201374536-Discord-keyboard-shortcuts) ou tire sua dúvida sobre a ferramenta no [#random](https://javadevbr.Discord.com/messages/random/). É fundamental também que todos usuários saibam como tirar o melhor proveito das threads oferecidas pelo Discord. Saiba mais como usar as threads no [post oficial do Discord](https://Discordhq.com/threaded-messaging-comes-to-Discord-417ffba054bd#.t5o624v3u).
